function detectDiscount = acousticDetectDiscount_last(signalTarget, sampleRateTarget, signalMasker, sampleRateMasker, axisTarget, axisMasker, timeSkip, timeStep, freqRange, outPlot)
...
if outPlot
    ...
    for iiPlot = 1:targetChans
        ...
        hold on
        plot(ax3, t, dBATDepMasker(:, maskChan), 'color', cmap_magma(70, :), 'DisplayName', "Masker")
